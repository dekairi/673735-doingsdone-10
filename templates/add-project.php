    ...
    <main class="content__main">
        ...
        <form class="form"  action="add-project.php" method="post" autocomplete="off">
          <div class="form__row">
            ...
            <input class="form__input <?=$classname; ?>" type="text" name="name" id="project_name" value="<?=array_key_exists("name", $errors) ? '' : getPostValue("name"); ?>" placeholder="Введите название проекта">
